  ...
  return (
    <nav className="nav">
      <div className="nav-in">
        ...
        <a className="link" href="https://arxiv.org/abs/2607.12520" target="_blank" rel="noreferrer" title="Paper on arXiv" style={{ fontFamily: 'var(--mono)', fontSize: '0.78rem', marginRight: 4 }}>arXiv ↗</a>
