"""v2 probe run: 36-model panel, judge v2 (context-aware), v2 inputs.
...
def main() -> None:
    ...
    entities = json.loads((inputs / "pilot_entities_v2.json").read_text())
    gold = json.loads((inputs / "gold_answers_v2.json").read_text())
    ...
    if args.pilot:
        ...
        out_path = HERE / "outputs" / "full_v2_results.jsonl"
