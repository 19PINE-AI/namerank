...
def main() -> None:
    ...
    entities = json.loads((inputs / "tier_entities.json").read_text())
    gold = json.loads((inputs / "tier_gold.json").read_text())
    ...
    results_path = outputs / "pilot_results_tiers.json"
    results: list[dict] = []
    ...
    csv_path = outputs / "tier_summary.csv"
