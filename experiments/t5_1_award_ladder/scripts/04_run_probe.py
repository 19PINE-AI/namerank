"""Probe the award-ladder cohort on the 36-model event panel.
...
def main() -> None:
    ...
    entities = json.loads((inputs / "award_entities.json").read_text())
    gold = json.loads((inputs / "award_gold.json").read_text())
    ...
    results_path = outputs / "pilot_results_awards.json"
    results: list[dict] = []
    ...
    csv_path = outputs / "award_summary.csv"
