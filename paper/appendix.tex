...
mid\_tier\_filmmaker & 38 & 0.786 & --- & Independent directors with multiple festival features \\
programming\_language & 29 & 0.779 & --- & Languages with $>1$M users (Python, Rust, Go, etc.) \\
mid\_tier\_artist & 45 & 0.774 & --- & Contemporary visual artists with major museum representation \\
database\_or\_data\_system & 30 & 0.773 & --- & Open-source databases (Postgres, ClickHouse, etc.) \\
award & 15 & 0.772 & --- & Major academic / industry awards (Turing, Nobel CS-relevant) \\
benchmark & 47 & 0.747 & 4\% & ML benchmarks (MMLU, GPQA, HellaSwag, etc.) \\
ai\_hardware & 20 & 0.730 & --- & AI accelerator products (H100, TPU v5, etc.) \\
dataset & 45 & 0.725 & 3\% & ML datasets (COCO, ImageNet, etc.) \\
mid\_tier\_musician & 64 & 0.692 & --- & Working musicians with mid-tier commercial success \\
mid\_tier\_chef & 47 & 0.645 & --- & Michelin-starred chefs not at the absolute top \\
mid\_tier\_comedian & 46 & 0.632 & --- & Comedians with Netflix specials but not headliners \\
research\_paper & 298 & 0.625 & 3\% & Highly-cited papers ($>10$K citations) \\
mid\_tier\_historical & 105 & 0.622 & --- & Pre-1980 historical figures, less-canonical \\
ai\_startup\_or\_company & 102 & 0.638 & 5\% & AI startups Series B+ founded post-2018 \\
conference & 30 & 0.610 & --- & CS / ML conferences (NeurIPS, ICML, etc.) \\
...
mid\_tier\_medical & 44 & 0.603 & --- & Mid-career physicians and medical researchers \\
mid\_tier\_product & 88 & 0.603 & --- & Consumer products with mid-tier adoption \\
named\_method & 73 & 0.557 & --- & Named ML methods (Adam, BatchNorm, Transformer, etc.) \\
...
mid\_tier\_journalist & 84 & 0.512 & --- & Working journalists at major outlets \\
mid\_tier\_religious & 30 & 0.486 & --- & Notable religious leaders \\
...
mid\_tier\_online\_course & 40 & 0.434 & --- & Notable online courses (CS50, MIT 6.006, etc.) \\
mid\_tier\_podcast & 57 & 0.427 & --- & Notable podcasts \\
\textbf{cs\_faculty} & \textbf{698} & \textbf{0.417} & 22\% & CS faculty from CS Rankings $\geq 1$ paper \\
mid\_tier\_vc & 31 & 0.402 & --- & Mid-tier VCs at top firms \\
\textbf{long\_tail\_paper} & 499 & 0.368 & 24\% & Long-tail academic papers $50$--$500$ citations \\
...
mid\_tier\_politician & 103 & 0.356 & --- & Mid-tier elected officials globally \\
...
\textbf{Per-model mention table for Jiayi Weng / Tianshou.} Of the $28$ non-refusal responses to ``tell me about Jiayi Weng,'' $7$ name Tianshou: claude-opus-4.6-think, claude-sonnet-4.6-think, gemini-3-flash-think, gemini-3.1-pro, glm-5.1-think, gpt-5.5-think, kimi-k2.6-think. All other models that respond do not name Tianshou. The $7$ mentioning models have judge scores ranging $0.70$ to $0.80$ (mean $0.71$); the $20$ non-mentioning responding models range $0.00$ to $0.50$ (mean $0.35$). The score lift from artifact-mention is $+0.36$.
